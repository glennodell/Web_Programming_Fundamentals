...
console.log("You will need a total of " + totalC + " computers, and a total of " + totalM + " monitors to complete these rooms. Also you will need at total of " + mice + " mice and keyboards you will also need " + powerCables + " powercables one for each computer and one for each monitor.")
